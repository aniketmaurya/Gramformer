...
class Gramformer:
    def __init__(self, models: int = 1, use_gpu: bool = False):
        ...
        self.annotator: Annotator = errant.load("en")
    ...
    def correct(self, input_sentence: str, max_candidates: int = 1) -> Optional[set]:
    ...
    def _get_edits(self, orig: str, cor):
